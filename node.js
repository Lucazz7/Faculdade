...
function sample() {
  ...
  var url_data = {
    host: "zeusagrolooker.cloud.looker.com",
    secret: import.meta.env.VITE_APP_LOOKER_SECRET,
    external_user_id: "57",
    first_name: "Zeus Minerva Project",
    last_name: "Zeus Minerva Project",
    group_ids: [4],
